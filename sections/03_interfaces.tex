...
\begin{frame}{Desktop agent apps: the IDE boundary is blurring}
  ...
  \end{columns}
  \vspace{0.25cm}
  \begin{center}\large\bfseries\color{deepblue}The interface is moving from editor-first to agent-first.\\[-0.05cm]
  \small\color{muted}For researchers, the relevant question is: \emph{can I review what changed?}\end{center}
\end{frame}
...
\begin{frame}{2. Research and browser assistants}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.46\textwidth}
      ...
      \smallsource{NotebookLM screenshot captured by Marco Le Moglie, 23 June 2026.}
  \end{columns}
  \vspace{0.1cm}
...
\begin{frame}{3. IDE agents}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.48\textwidth}
      ...
      \smallsource{Antigravity IDE screenshot captured by Marco Le Moglie, 23 June 2026.}
  \end{columns}
\end{frame}
