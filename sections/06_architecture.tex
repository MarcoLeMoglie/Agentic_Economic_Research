...
\begin{frame}{MCP vs API vs CLI}
  ...
  \vspace{0.15cm}
  \begin{center}\scriptsize\color{muted}Simple rule: the more tools you expose to the model, the more context you spend before the task even starts.\end{center}
\end{frame}
