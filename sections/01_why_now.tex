...
\begin{frame}{Adoption among researchers is no longer marginal}
  ...
  \end{columns}
  \smallsource{Van Noorden \& Perkel, \emph{Nature} 2023; Pew Research 2024 survey of US professionals; Anthropic Economic Index \citeyearpar{anthropic_economic_index_2024} 2024--2025 update. Numbers are rounded indicative ranges; update before teaching.}
\end{frame}
...
\begin{frame}{Three things that changed since ``ChatGPT 2023''}
  ...
  \begin{tikzpicture}[every node/.style={align=center,font=\small}]
    ...
    \node[draw=accent,fill=softorange,rounded corners,very thick,
          ...
          (memory){\textbf{2. Memory}\\\scriptsize session, project, persistent\\\scriptsize the model carries state};
    \node[draw=deepblue,fill=softgreen,rounded corners,very thick,
          minimum width=3.6cm,minimum height=2.3cm,text width=3.3cm,
