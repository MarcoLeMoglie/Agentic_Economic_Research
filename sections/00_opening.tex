...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=north west,inner sep=1.3cm,text=white,align=left,text width=0.86\paperwidth] at (current page.north west){%
      ...
      {\small Mini-course for PhD students and faculty\,\textbar\,4 hours}\\[0.05cm]
      {\small Agentic Economic Research seminar\,\textbar\,1 July 2026}};
    \node[anchor=south west,inner sep=1.0cm,text=white,opacity=0.85]
      at (current page.south west){\scriptsize v1.0\,\textbar\,Session 1 of 2 (concepts \& tools)};
  \end{tikzpicture}
\end{frame}
