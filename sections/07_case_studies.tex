...
\begin{frame}{Where agents fit across the pipeline}
  ...
  \begin{tikzpicture}[every node/.style={align=center,font=\scriptsize}]
    ...
    \node[below=0.15cm of rev,color=accent] {review gate};
  \end{tikzpicture}
  \end{center}
  \vspace{0.2cm}
  \begin{center}
    \scriptsize
    \tikz{\node[draw=muted,fill=white,rounded corners,inner sep=2pt,align=center]{%
      \textcolor{muted}{\rule{0.6em}{0.6em}}~low trust \quad
      \textcolor{accent}{\rule{0.6em}{0.6em}}~medium trust \quad
      \textcolor{good}{\rule{0.6em}{0.6em}}~high trust\\
      \textcolor{accent!70!deepblue}{\rule{0.6em}{0.6em}}~human-review gate};}
  \end{center}
  \vspace{0.25cm}
