...
| Compile | Main document | Output PDF |
|---------|---------------|------------|
| Overleaf default | `main.tex` (`\CompileSession=2`) | `main.pdf` |
| Direct | `session2/session2.tex` | `session2/session2.pdf` |

## Sections

- `sections/00_opening.tex` — title, roadmap, Parts 1–4
- `sections/03_success_stories.tex` — YouTube, ASSIST Weekly, Mafia Culture
